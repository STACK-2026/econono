...
FROM = alertes@send.econono.com (domaine verifie Resend; onboarding@resend.dev ne livre plus qu'au owner
...
FROM_EMAIL = "alertes@send.econono.com"
TO_EMAIL = "augustin.foucheres@gmail.com"
REPO = "STACK-2026/econono"
...
def main() -> int:
    ...
    subject = f"[econono] Deploy FAIL : {workflow}"
