...
export const glossaire: Record<string, GlossaireEntry> = {
  ...
  "rachat de crédit": {
    ...
    internalLink: { href: "/calculateurs/taux-endettement/", label: "Calcul taux d'endettement" },
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F2440", label: "Service-Public · rachat" },
    category: "credit",
  ...
  "amortissement": {
    ...
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F16123", label: "Service-Public · prêt immo" },
    category: "credit",
  },
  "surendettement": {
  ...
  "pel": {
    ...
    internalLink: { href: "/calculateurs/epargne/", label: "Simulateur d'épargne" },
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F16140", label: "Service-Public · PEL" },
    category: "epargne",
  ...
  "assurance vie": {
    ...
    internalLink: { href: "/calculateurs/epargne/", label: "Simulateur d'épargne" },
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F15274", label: "Service-Public · assurance vie" },
    category: "epargne",
  },
  "pea": {
    ...
    internalLink: { href: "/calculateurs/epargne/", label: "Simulateur d'épargne" },
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F2385", label: "Service-Public · PEA" },
    category: "epargne",
  ...
  "rfr": {
    ...
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F13216", label: "Service-Public · RFR" },
    category: "fiscalite",
  ...
  "als": {
    ...
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/N20360", label: "Service-Public · ALS" },
    category: "social",
  ...
  "agios": {
    ...
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F2440", label: "Service-Public · agios" },
    category: "bancaire",
  ...
  "prélèvement sepa": {
    ...
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F20752", label: "Service-Public · SEPA" },
    category: "bancaire",
