...
category: "guide"
tags: ["LEP plafond 2026"]
image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=80"
imageAlt: "Illustration LEP 2026 : plafond revenu, taux à 4%, éligibilité (calculateur)"
keywords: "LEP plafond 2026"
draft: false
---

**TL;DR**
Le **LEP 2026** (Livret d’Épargne Populaire) rapporte **4% d’intérêts** depuis mars 2026, mais seulement si ton revenu fiscal de référence (RFR) ne dépasse pas **22 500 € pour une personne seule** ou **34 480 € pour un couple**. 11 millions de Français y ont droit, mais 60% l’ignorent. Voici comment vérifier ton éligibilité, ouvrir ton LEP en ligne et maximiser tes gains sans risque.
...
![Un couple compare les taux du LEP et du Livret A sur une calculatrice](IMAGE_1)
...
1. Connecte-toi sur [impots.gouv.fr](https://www.impots.gouv.fr/).
2. Télécharge ton **avis d’imposition 2025** (revenus 2024).
3. Cherche la case **"Revenu fiscal de référence"**.
4. Compare ce chiffre avec les plafonds du tableau ci-dessus.
...
👉 [Calculer mon éligibilité LEP (Econono)](https://econono.com/calculateurs/epargne/)
...
|----------------------|-------------------|-------|---------------|------|
| **Crédit Mutuel**    | 24h               | 0 €   | 4%            | [Ouvrir un LEP](https://www.creditmutuel.fr/) |
| **CIC**              | 48h               | 0 €   | 4%            | [Ouvrir un LEP](https://www.cic.fr/) |
| **La Banque Postale**| 3 jours           | 0 €   | 4%            | [Ouvrir un LEP](https://www.labanquepostale.fr/) |
| **Boursorama**       | 5 jours           | 0 €   | 4%            | [Ouvrir un LEP](https://www.boursorama-banque.com/) |
| **Fortuneo**         | 3 jours           | 0 €   | 4%            | [Ouvrir un LEP](https://www.fortuneo.fr/) |
...
Pour ouvrir ton LEP, tu auras besoin de :
✅ **Ton avis d’imposition 2025** (pour prouver ton RFR).
✅ **Une pièce d’identité** (CNI, passeport).
✅ **Un justificatif de domicile** (facture EDF, quittance de loyer).
✅ **Ton RIB** (si tu veux transférer de l’argent depuis un autre compte).

*Astuce* : Si tu n’as pas ton avis d’imposition sous la main, tu peux le télécharger directement sur [impots.gouv.fr](https://www.impots.gouv.fr/).
...
1. Rends-toi sur [boursorama-banque.com](https://www.boursorama-banque.com/).
2. Clique sur **"Ouvrir un compte"** → **"LEP"**.
3. Remplis le formulaire avec tes infos (nom, adresse, RFR).
4. Télécharge ton **avis d’imposition 2025** et ta **pièce d’identité**.
5. Signe électroniquement (via SMS ou appli).
6. Reçois ton **numéro de LEP** sous 48h.
...
![Un tableau comparatif des livrets d'épargne en 2026](IMAGE_2)
...
👉 [Calculer ton plafond LEP (Econono)](https://econono.com/calculateurs/epargne/)
...
1. Consulte tes **relevés bancaires** (cherche "LEP" ou "Livret Épargne Populaire").
2. Appelle ta banque et demande un **relevé de compte**.
3. Vérifie sur **impots.gouv.fr** (dans la section "Mes comptes bancaires").
...
👉 **Prêt à ouvrir ton LEP ?** Utilise notre [calculateur d’épargne](https://econono.com/calculateurs/epargne/) pour savoir combien tu peux gagner.
