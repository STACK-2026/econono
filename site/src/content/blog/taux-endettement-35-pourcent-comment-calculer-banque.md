...
category: "guide"
tags: ["calcul taux endettement"]
image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=80"
imageAlt: "Illustration Calcul taux d'endettement 2026 : la règle des 35% expliquée (calcul officiel HCS"
keywords: "calcul taux endettement"
draft: false
---

**TL;DR**
Ton **taux d'endettement** (part de tes revenus consacrée aux crédits) est plafonné à **35% depuis 2022** par le HCSF (Haut Conseil de Stabilité Financière). Pour un salaire de 2 500 € net, tes mensualités max sont de **875 €/mois**. Mais 20% des dossiers obtiennent une dérogation. On t’explique le calcul exact, les exceptions, et comment négocier avec ta banque.
...
👉 *Tu veux calculer ton taux d’endettement en 10 secondes ? Utilise notre [calculateur officiel](/calculateurs/taux-endettement/) (gratuit, sans inscription).*

---

## La formule officielle du taux d’endettement (calcul HCSF 2026)
...
*Taux d’emprunt indicatif en avril 2026 (source : [Banque de France](https://www.banque-france.fr/)). Les montants sont des estimations : le coût du crédit dépend aussi de ta durée d’emprunt, de ton apport, et de ton profil.

💡 **Cas particulier : les couples**
Si tu es en couple, les banques additionnent vos revenus **et** vos mensualités. Exemple :
- Toi : 2 000 € net/mois + 300 € de crédit auto.
- Ton·ta partenaire : 1 800 € net/mois + 0 € de crédit.
→ Revenus totaux : 3 800 €.
→ Mensualités totales : 300 €.
→ Taux d’endettement : **7,9%** (300 ÷ 3 800 × 100). Vous pouvez emprunter jusqu’à **1 030 €/mois** (35% de 3 800 € - 300 €).
...
1. **Calcule ton taux d’endettement actuel** (avec ton crédit auto).
2. **Vérifie que tu es en dessous de 35%**.
3. **Regarde ton reste à vivre** (ce qu’il te reste après avoir payé tes crédits et tes charges fixes).
...
## La règle des 35% : 20% de dérogations possibles
...
2. **Fais jouer la concurrence** : certaines banques sont plus souples que d’autres. Compare les offres avec un courtier (gratuit pour toi, la banque le rémunère).
3. **Mets en avant ton reste à vivre** : même avec un taux d’endettement à 38%, si tu as 2 000 €/mois de reste à vivre, la banque peut accepter.
4. **Négocie** : si tu es un bon client (peu de découverts, épargne régulière), demande à ton conseiller de plaider ta cause auprès du service des risques.
...
- Même prêt sur 25 ans → mensualité : 1 000 €.
→ Gain : **150 €/mois**, soit une baisse de 12,5% de ton taux d’endettement (si tes revenus sont de 3 000 €/mois).

⚠️ **Attention** : plus la durée est longue, plus le coût total du crédit augmente. Compare avec notre [calculateur de coût de crédit](/calculateurs/cout-credit/).
...
👉 *Pour savoir comment ta banque traite les aides, demande à ton conseiller ou utilise notre [calculateur de revenus](/calculateurs/salaire-net/).*
...
1. **Demande une dérogation** (si tu es un bon profil, voir plus haut).
2. **Fais jouer la concurrence** : certaines banques en ligne (Boursorama, Fortuneo…) ou néobanques (Revolut, N26…) sont plus souples.
3. **Passe par un courtier** : il connaît les banques qui acceptent les dossiers limites et peut négocier pour toi.
4. **Attends quelques mois** : si tu peux épargner pour augmenter ton apport ou rembourser un crédit en cours, ton taux d’endettement baissera.
...
👉 **Prêt à calculer ton taux d’endettement ?** Utilise notre [calculateur officiel](/calculateurs/taux-endettement/) (gratuit, sans inscription) et découvre en 10 secondes si tu peux emprunter.

💌 **Tu veux plus de conseils pour gérer ton budget ?** Abonne-toi au [Carnet d’Econono](https://econono.com/newsletter/) : des astuces concrètes, sans jargon, pour reprendre le contrôle de tes finances.
