---
title: "LEP 2026 : 3,5 % net, 10 000 € · qui est éligible"
description: "Le LEP rapporte 3,5% net en 2026 (vs 3% pour le Livret A). 1 Français sur 4 éligible ne l'a pas. Vérifie ton éligibilité, ouvre-le en 5 min et gagne 350 €/an."
date: 2026-05-03T06:09:08+00:00
lastReviewed: 2026-05-03
author: "Léa Dubreuil"
reviewedBy: "Économono Editorial"
category: "guide"
tags: ["lep livret épargne populaire"]
image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=80"
imageAlt: "Illustration LEP 2026 : 3,5% net, 10 000 € de plafond · Éligible ? Ouvre-le vite"
keywords: "lep livret épargne populaire"
draft: false
---

**TL;DR**
Le **LEP (Livret d'Épargne Populaire)** te rapporte **3,5% net en 2026** - soit **0,5 point de plus que le Livret A**. Plafond à **10 000 €**, exonéré d’impôts. **1 Français éligible sur 4 ne l’a pas ouvert** (Banque de France, 2025). Pour en profiter : ton **revenu fiscal de référence (RFR) 2024** doit être ≤ **22 940 €** pour 1 part. On t’explique comment vérifier ton éligibilité, l’ouvrir en ligne, et combien tu peux gagner (exemple : **350 €/an sur 10 000 €**).
...
| Nombre de parts fiscales | Plafond RFR 2024 (€) |
|--------------------------|----------------------|
...
👉 **Pas sûr·e de ton nombre de parts ?** Utilise notre [calculateur de parts fiscales](/calculateurs/salaire-net/) pour le vérifier.
...
→ Utilise le tableau ci-dessus ou notre [calculateur LEP](/blog/lep-livret-epargne-populaire-eligible-comment-ouvrir/).
...
👉 **Besoin d’aide ?** Consulte notre [guide pas à pas pour ouvrir un LEP](/blog/lep-livret-epargne-populaire-eligible-comment-ouvrir/).
...
**Exemple 1** :
Tu places **5 000 €** sur un LEP à 3,5%.
→ **175 € de gains par an** (soit **14,58 €/mois**).
→ Si tu ajoutes **50 €/mois** pendant 1 an, tu auras **6 200 €** + **217 € d’intérêts** (soit **6 417 €** au total).

**Exemple 2** :
Tu as **10 000 €** sur un Livret A à 3%.
→ **300 € de gains par an**.
Si tu transfères tout sur un LEP à 3,5% :
→ **+50 € de gains en plus** (soit **350 €/an**).

👉 **Calcule tes gains exacts** avec notre [simulateur LEP](/blog/lep-livret-epargne-populaire-eligible-comment-ouvrir/).
...
|-----------------------|----------------------|----------------------|----------------------|
| **Taux d’intérêt**    | 3,5% net             | 3% net               | 3% net               |
| **Plafond**           | 10 000 €             | 22 950 €             | 12 000 €             |
| **Fiscalité**         | Exonéré              | Exonéré              | Exonéré              |
| **Éligibilité**       | Revenus modestes     | Tout le monde        | Tout le monde        |
| **Disponibilité**     | Immédiate            | Immédiate            | Immédiate            |
| **Nombre de livrets** | 1 par personne       | 1 par personne       | 1 par personne       |

**Quand choisir le LEP ?**
✅ Tu es **éligible** (RFR ≤ plafond).
✅ Tu veux **le meilleur taux sans risque**.
✅ Tu as **moins de 10 000 € à placer**.

**Quand choisir le Livret A ou LDDS ?**
✅ Tu **n’es pas éligible** au LEP.
✅ Tu as **plus de 10 000 € à placer** (le Livret A a un plafond plus élevé).
✅ Tu veux **un livret accessible à tous** (pour tes enfants, par exemple).

👉 **Besoin d’aide pour choisir ?** Utilise notre [comparateur de livrets](/blog/livret-a-2026-taux-fonctionnement-strategie/).
...
→ **Solution** : Vérifie ton **RFR 2024** sur ton avis d’imposition 2025. Utilise notre [calculateur LEP](/blog/lep-livret-epargne-populaire-eligible-comment-ouvrir/) si tu as un doute.
...
💡 **Le saviez-vous ?**
En 2025, **4,2 millions de Français** auraient pu ouvrir un LEP mais ne l’ont pas fait (Banque de France). **Ne fais pas partie des oubliés !**
...
- **Ton conjoint** : 1 LEP + 1 Livret A.
→ **20 000 € sur LEP + 45 900 € sur Livret A** pour un couple.
...
- En 2026, ton RFR 2025 est de **24 000 €** (non éligible).
→ Tu ne peux plus verser d’argent sur ton LEP, mais tu gardes tes **10 000 € + intérêts**.
...
👉 **Tu veux savoir si tu es éligible ?** Utilise notre [calculateur LEP](/blog/lep-livret-epargne-populaire-eligible-comment-ouvrir/) et ouvre ton livret dès aujourd’hui.

💌 **Tu veux plus de conseils pour gérer ton budget ?** Abonne-toi à [notre newsletter Le Carnet](https://econono.com/newsletter/) - 1 email par semaine, sans spam, avec des astuces concrètes pour économiser et épargner.
