...
Contrairement à ton épargne "projet" (pour un achat immobilier, par exemple), l’épargne de précaution doit être :
✅ **Disponible immédiatement** : tu dois pouvoir y accéder en 24-48h max.
✅ **Sans risque** : pas de placements en Bourse, pas de crypto, pas de SCPI.
✅ **Stable** : pas de variation de valeur (un livret A ne perd jamais d’argent).
...
- **Revenus faibles (500 à 1 000 €/mois)** :
  ...
  - *Comment faire ?* Même avec un petit budget, essaie de mettre 20-50 €/mois de côté. Un job étudiant, une aide familiale ou des économies sur les courses (voir notre [guide pour économiser sur son budget étudiant](/calculateurs/budget-etudiant/)) peuvent t’aider.
...
*Tu veux un calcul personnalisé ?* Utilise notre [calculateur d’épargne de précaution](/calculateurs/epargne/) pour obtenir un montant précis selon tes revenus et tes charges.
...
✔ **Disponible en 24-48h** (pas de délai de retrait).
✔ **Sans risque de perte** (pas de Bourse, pas de crypto).
✔ **Liquide** (tu peux retirer l’argent quand tu veux).
...
*Comment savoir si tu es éligible ?* Vérifie ton revenu fiscal de référence sur ton avis d’imposition 2025 (disponible sur [impots.gouv.fr](https://www.impots.gouv.fr/)).
...
👉 **Stratégie optimale** :
1. Remplis d’abord ton **LEP** (si éligible) → 5 % de rendement.
2. Complète avec ton **Livret A** → 3 %.
3. Utilise le **LDDS** pour le reste.
4. Si tu as encore de l’argent à placer, ouvre un **compte à terme** ou une **assurance-vie en fonds euros**.
...
Utilise notre [calculateur d’épargne de précaution](/calculateurs/epargne/) pour savoir *combien* tu dois épargner. Par exemple :
...
👉 **Astuce** : Utilise une app comme [Linxo](https://www.linxo.com/) ou [Bankin’](https://www.bankin.com/) pour suivre tes économies et ajuster ton budget.

### 4️⃣ Étape 4 : Trouve des économies pour accélérer
Même avec un petit budget, tu peux gratter des euros ici et là :
- **Courses** : -100 €/mois en évitant le gaspillage et en achetant en vrac (voir notre [guide pour économiser sur son budget courses](/calculateurs/budget-courses/)).
- **Abonnements** : -30 €/mois en résiliant Netflix, Spotify ou ton abonnement salle de sport (utilise notre [comparateur d’abonnements](/calculateurs/comparateur-abonnements/)).
- **Énergie** : -20 €/mois en baissant le chauffage de 1°C ou en éteignant les appareils en veille (voir les conseils de l’[ADEME](https://www.ademe.fr/)).
...
- **Prime d’activité** : Si tu gagnes entre 0,5 et 1,5 SMIC, tu peux toucher jusqu’à **200 €/mois** (calcule ton éligibilité sur [caf.fr](https://www.caf.fr/)).
...
- **Solution** : Fais une liste *précise* de tes charges fixes (utilise notre [calculateur de budget mensuel](/calculateurs/budget-mensuel/)).
...
- **Trouve des économies** : utilise notre [calculateur de budget courses](/calculateurs/budget-courses/) pour réduire tes dépenses alimentaires.
...
- **Demande de l’aide** : si tu es en difficulté, des associations comme le [Secours Populaire](https://www.secourspopulaire.fr/) ou la [Croix-Rouge](https://www.croix-rouge.fr/) peuvent t’aider ponctuellement.
...
- Pôle Emploi · [Durée moyenne d’indemnisation chômage](https://www.pole-emploi.fr/) (2025).
- ADEME · [Économies d’énergie à la maison](https://www.ademe.fr/) (2026).
- La Finance pour Tous · [Guide de l’épargne de précaution](https://www.lafinancepourtous.com/) (2025).
...
👉 **Prochaine étape** : Calcule *ton* montant idéal avec notre [calculateur d’épargne de précaution](/calculateurs/epargne/) et ouvre un Livret A ou un LEP dès aujourd’hui.

*Tu veux recevoir nos conseils pour mieux gérer ton budget chaque mois ?* Abonne-toi au [Carnet d’Econono](https://econono.com/newsletter/) (gratuit, sans spam).
