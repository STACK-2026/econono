...
category: "guide"
tags: ["investir 100 euros par mois"]
image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=80"
imageAlt: "Illustration Investir 100 € par mois en 2026 : stratégie ETF et DCA pour débutants"
keywords: "investir 100 euros par mois"
draft: false
---

**TL;DR**
Tu veux investir **100 € par mois** mais tu ne sais pas par où commencer ? Voici la stratégie simple qui marche en 2026 :
...
*Source : calculateur d’épargne [Econono](/calculateurs/epargne/) avec hypothèse de 5% de rendement annuel net.*
...
- En mars, le prix baisse à 40 € → tu achètes **2,5 parts**.
→ À la fin, tu as acheté à un **prix moyen**, sans te prendre la tête.
...
*Le saviez-tu ?* En 2026, le **SMIC net** est à **1 443 €/mois** (Service-Public.fr). Si tu es au SMIC, 100 €/mois représentent **7% de ton revenu**. C’est un effort, mais c’est faisable si tu optimises ton budget (avec notre [calculateur de reste à vivre](/calculateurs/reste-a-vivre/), par exemple).
...
Un **ETF (Exchange-Traded Fund)** est un fonds qui reproduit un indice boursier. Un **ETF World** suit les grandes entreprises mondiales (Apple, Microsoft, LVMH, Samsung…). En achetant **une seule part d’ETF World**, tu investis dans **des centaines d’entreprises** à la fois. C’est la **diversification automatique**.

**Pourquoi un PEA ?**
Le **PEA (Plan d’Épargne en Actions)** est un compte spécial pour investir en Bourse en France. Ses avantages :
...
**Quel ETF World choisir ?**
En France, les ETF World les plus populaires sont :
...
*Comparatif rapide* :
| ETF          | Frais annuels | Devise | Distribuant/Capitalisant | Où l’acheter ?          |
|--------------|---------------|--------|--------------------------|-------------------------|
| CW8 (Amundi) | 0,28%         | EUR    | Capitalisant             | Boursorama, Fortuneo    |
| EWLD (Lyxor) | 0,20%         | EUR    | Capitalisant             | Trade Republic, Bourse Direct |
| IWDA (iShares)| 0,20%        | USD    | Capitalisant             | Interactive Brokers     |
...
**Pour qui ?** Les débutants qui veulent une appli intuitive et des frais bas.
**Frais** :
- **1 € par ordre** (peu importe le montant).
- **Pas de frais de garde**.
- **Frais de change** : 0,5% si tu achètes un ETF en dollars (comme IWDA).
**Avantages** :
...
**Pour qui ?** Ceux qui veulent un courtier français avec des outils avancés.
**Frais** :
- **0,99 € par ordre** (gratuit si tu as plus de 500 € de portefeuille).
- **Pas de frais de garde**.
- **Frais de change** : 0,09% (moins cher que Trade Republic).
**Avantages** :
- **Offre complète** : PEA, CTO, PER, assurance-vie…
- **Outils d’analyse** : graphiques, alertes, analyses techniques.
- **Gratuit si tu as un compte bancaire Boursorama** (ce qui est souvent le cas).
**Inconvénients** :
...
**Pour qui ?** Ceux qui veulent un PEA sans frais et une appli simple.
**Frais** :
- **Gratuit pour les ordres sur ETF** (si tu achètes CW8 ou EWLD).
- **Pas de frais de garde**.
- **Frais de change** : 0,1% (moins cher que Trade Republic).
**Avantages** :
- **Gratuit pour les ETF** : idéal pour investir 100 €/mois sans frais.
- **Appli simple et efficace**.
- **Offre bancaire intégrée** (compte courant, carte gratuite).
**Inconvénients** :
...
| Courtier       | Frais par ordre (ETF) | Frais de garde | Frais de change | Appli intuitive | PEA disponible | CTO disponible | PER disponible |
|----------------|-----------------------|----------------|-----------------|-----------------|----------------|----------------|----------------|
| Trade Republic | 1 €                   | Non            | 0,5%            | ⭐⭐⭐⭐⭐        | Oui            | Oui            | Non             |
| Boursorama     | 0,99 € (gratuit >500 €)| Non            | 0,09%           | ⭐⭐⭐⭐          | Oui            | Oui            | Oui             |
| Fortuneo       | Gratuit (ETF)         | Non            | 0,1%            | ⭐⭐⭐⭐          | Oui            | Oui            | Oui             |
| Interactive Brokers | 0,05% (min 1,25 €) | Non            | 0,002%          | ⭐⭐⭐           | Oui            | Oui            | Oui             |

*Notre recommandation* :
- **Débutant avec 100 €/mois** → **Trade Republic** (simple et pas cher).
- **Veux un courtier français complet** → **Boursorama**.
- **Veux investir dans CW8/ETF sans frais** → **Fortuneo**.
...
| Durée  | 3% de rendement | 5% de rendement | 7% de rendement |
|--------|-----------------|-----------------|-----------------|
| 5 ans  | 6 400 €         | 6 800 €         | 7 200 €         |
| 10 ans | 14 000 €        | 15 600 €        | 17 400 €        |
| 15 ans | 22 800 €        | 26 800 €        | 31 600 €        |
| 20 ans | 33 200 €        | 40 800 €        | 50 400 €        |
| 25 ans | 45 600 €        | 58 800 €        | 75 600 €        |
| 30 ans | 60 400 €        | 82 000 €        | 110 400 €       |

*Source : calculs réalisés avec le [calculateur d’épargne Econono](/calculateurs/epargne/).*
...
**Le problème** : Tu attends "le bon moment" pour investir, et tu rates des mois (voire des années) de rendement.
**La réalité** : **Personne ne sait prédire les marchés**. Même les professionnels se trompent.
**La solution** : **Investis régulièrement** (DCA), sans te soucier des fluctuations. Comme le dit Warren Buffett : *"Le meilleur moment pour planter un arbre, c’était il y a 20 ans. Le deuxième meilleur moment, c’est maintenant."*
...
**Le problème** : Les frais de courtage, de gestion ou de change peuvent **grignoter tes gains** sans que tu t’en rendes compte.
**La réalité** : 1% de frais en plus par an, c’est **20% de rendement en moins sur 20 ans**.
**La solution** :
...
**Le problème** : Quand les marchés baissent, tu vends tout par peur de perdre plus.
**La réalité** : **Les baisses font partie du jeu**. Si tu vends, tu **cristallises tes pertes**.
**La solution** :
...
**Le problème** : Tu ne tiens pas compte des impôts, et tu te retrouves avec une mauvaise surprise à la revente.
**La réalité** :
...
- **PER** : imposition à la sortie (mais déduction d’impôt à l’entrée).
**La solution** :
...
**Le problème** : Tu mets tout ton argent dans une seule action (Tesla, Amazon…) ou un seul secteur (tech, crypto…).
**La réalité** : **Une action peut s’effondrer** (exemple : Wirecard, qui a perdu 100% de sa valeur en 2020).
**La solution** :
...
- Amundi · [Fiche technique CW8](https://www.amundietf.fr/)
- Lyxor · [Fiche technique EWLD](https://www.lyxoretf.fr/)
- Trade Republic · [Frais de courtage](https://www.traderepublic.com/fr-fr)
- Boursorama · [Frais de courtage](https://www.boursorama.com/)
- Fortuneo · [Frais de courtage](https://www.fortuneo.fr/)
...
**Et toi, tu es prêt·e à commencer ?** Utilise notre [calculateur d’épargne](/calculateurs/epargne/) pour simuler ton propre scénario, ou abonne-toi au [Carnet Econono](https://econono.com/newsletter/) pour recevoir nos conseils chaque mois. 🚀
