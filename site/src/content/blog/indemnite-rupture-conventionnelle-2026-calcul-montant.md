---
title: "Indemnité de rupture conventionnelle 2026 : calcul, montant et fiscalité"
description: "Calcul de l'indemnité de rupture conventionnelle 2026 : formule officielle (1/4 puis 1/3 de mois par année), plancher légal, fiscalité et droit au chômage."
date: 2026-06-10T07:30:00+00:00
lastReviewed: 2026-06-10
author: "Sophie Vallet"
reviewedBy: "Econono Editorial"
category: "guide"
tags: ["indemnité rupture conventionnelle 2026"]
image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200&h=630&fit=crop&crop=center&q=80"
imageAlt: "Bureau avec calculatrice, contrat de travail et stylo pour calculer une indemnité de rupture conventionnelle en 2026"
keywords: "indemnité rupture conventionnelle 2026"
draft: false
tldr:
  - "Le plancher légal d'indemnité vaut 1/4 de mois de salaire par année jusqu'à 10 ans, puis 1/3 de mois par année au-delà."
  - "L'indemnité ne peut jamais être inférieure à l'indemnité légale de licenciement, et la convention collective peut imposer plus."
  - "Une partie de l'indemnité est exonérée d'impôt sur le revenu, mais la CSG-CRDS et parfois les cotisations sociales s'appliquent."
  - "La rupture conventionnelle ouvre droit au chômage, après un délai de carence (différés d'indemnisation) à France Travail."
---
...
1. **Un ou plusieurs entretiens** où tu peux te faire assister.
2. La signature d'une **convention de rupture** qui fixe la date de départ et le montant de l'indemnité.
3. Un **délai de rétractation de 15 jours calendaires** pour chacune des deux parties.
4. La **validation (homologation)** par la DREETS, l'administration du travail, dans un délai de 15 jours ouvrables.
...
![ALT rupture conventionnelle 2026 indemnité calcul salarié employeur](IMAGE_1)
...
*Source : [Légifrance - Article R1234-2 du Code du travail](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000036517433)*
...
1. La **moyenne des 12 derniers mois** de salaire brut précédant la rupture.
2. La **moyenne des 3 derniers mois** de salaire brut (avec les primes annuelles ou exceptionnelles versées sur cette période recalculées au prorata).
...
*Source : [Service-Public.fr - Indemnité légale de licenciement (2026)](https://www.service-public.fr/particuliers/vosdroits/F987)*

👉 Tu veux convertir ton brut en net pour t'y retrouver ? Passe par notre [calculateur de salaire net](/calculateurs/salaire-net/).

---

## La convention collective peut imposer plus
...
1. Repère le nom de ta **convention collective** (il figure sur ta fiche de paie).
2. Cherche l'article sur l'**indemnité de licenciement** dans cette convention.
3. Compare le résultat avec le calcul légal et garde **le plus élevé**.
...
👉 Pour comprendre comment la CSG-CRDS grignote tes revenus, lis notre guide [CSG-CRDS 2026 : taux, calcul et fiche de paie expliqués](/blog/csg-crds-2026-taux-calcul-fiche-paie-explique/).
...
## Exemples concrets : combien tu touches selon ta situation
...
1. **Le coût d'un licenciement pour l'employeur**. Un licenciement contesté aux prud'hommes coûte cher et prend du temps. La rupture conventionnelle lui achète la tranquillité : ça se monnaie.
2. **Ton ancienneté et ton expertise**. Plus tu es difficile à remplacer, plus tu pèses.
3. **Le contexte de l'entreprise**. Réorganisation, fusion, suppression de poste déguisée : autant de situations où l'employeur a tout intérêt à un départ rapide.
4. **La part supra-légale et le chômage**. Garde en tête le différé d'indemnisation : parfois mieux vaut une indemnité un peu plus basse mais un chômage qui démarre plus tôt.
5. **Le timing**. Négocier en fin d'année ou avant une grosse prime peut gonfler ton salaire de référence calculé sur 3 mois.

👉 Pour muscler ta technique de négociation, notre guide [Comment négocier une augmentation de salaire 2026](/blog/comment-negocier-augmentation-salaire-2026-arguments-chiffres/) donne des arguments transposables à une rupture.
...
*Source : [Légifrance - Article R1234-2](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000036517433)*
...
Tu veux estimer ce que tu vas vraiment toucher chaque mois après ton départ ? Passe par notre [calculateur de salaire net](/calculateurs/salaire-net/) et notre [calculateur de reste à vivre](/calculateurs/reste-a-vivre/) pour piloter ta transition sereinement.

Et si tu veux recevoir nos meilleurs conseils pour gérer ton budget sans jargon, abonne-toi à [notre newsletter Le Carnet](https://econono.com/newsletter/). On t'envoie des astuces concrètes, sans pub déguisée. Parce que gérer son argent, ça devrait être simple.
