...
Prends un tableur (Excel, Google Sheets) ou une appli comme [Bankin’](https://www.bankin.com/) ou [Linxo](https://www.linxo.com/), et note **toutes tes dépenses sur 3 mois**. Classe-les en 3 catégories :
...
- **Tes abonnements** : As-tu vraiment besoin de Netflix *et* Disney+ *et* Canal+ ? Utilise [notre comparateur d’abonnements](/calculateurs/comparateur-abonnements/) pour voir où tu peux économiser.
- **Tes assurances** : Compare les offres avec [LesFurets.com](https://www.lesfurets.com/) ou [LeLynx.fr](https://www.lelynx.fr/).
- **Tes crédits** : Peux-tu renégocier ton taux ? Regrouper tes crédits ? Utilise [notre calculateur de coût de crédit](/calculateurs/cout-credit/) pour voir les économies possibles.
...
- **Courses** : Utilise des apps comme [Too Good To Go](https://toogoodtoogo.org/fr) pour acheter des invendus à prix réduits. Planifie tes menus à l’avance pour éviter le gaspillage.
- **Transports** : Si tu es en ville, privilégie les transports en commun ou le vélo. Si tu es à la campagne, essaie le covoiturage (via [BlaBlaCar Daily](https://www.blablacar.fr/daily)).
- **Énergie** : Baisse ton chauffage de 1°C (ça fait **7% d’économie** sur ta facture, selon l’[ADEME](https://www.ademe.fr/)). Éteins les appareils en veille.
...
- **Aides sociales** : Vérifie si tu as droit au **RSA**, aux **APL**, ou à la **prime d’activité** avec [le simulateur de la CAF](https://www.caf.fr/).
...
3. **Demande de l’aide** : La [Banque de France](https://www.banque-france.fr/) propose des **conseillers en surendettement** gratuits. Tu peux aussi contacter une [association comme Crésus](https://www.cresus.org/).
